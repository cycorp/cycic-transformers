...
class CycicProcessor(DataProcessor):
    ...
    def _create_examples(self, questions, answers, type):
        ...
        for question, answer in zip(questions, answers):
            ...
            label = str(answer["correct_answer"])
    ...
    for (ex_index, example) in tqdm.tqdm(enumerate(examples), desc="convert examples to features"):
        ...
        for ending_idx, (context, ending) in enumerate(zip(example.contexts, example.endings)):
            ...
            inputs = tokenizer.encode_plus(
                text_a, text_b, add_special_tokens=True, max_length=max_length, pad_to_max_length=True, truncation=True,
            )
...
""" cyc python command:
export CYC_DIR=/home/steeter/work/bert/cyc-data/
...
--num_train_epochs 3 \
--max_seq_length 80 \
--output_dir models_bert/cyc_dev \
